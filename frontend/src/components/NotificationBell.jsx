...
const ROUTE_FOR = {
  ...
  CounterOfferReceived: "/offers",
  OfferRejected: "/offers",
      ...
      <button className="nav-link" onClick={() => { setOpen((o) => !o); if (!open) refresh(); }}
        ...
        {count > 0 && (
          <span data-testid="notification-badge"
            style={{ position: "absolute", top: -2, right: -4, background: "var(--text)",
      ...
      {open && (
        <div data-testid="notification-dropdown"
          style={{ position: "absolute", right: 0, top: 34, width: 340, maxHeight: 440,
            ...
            borderRadius: 12, zIndex: 50, boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}>
